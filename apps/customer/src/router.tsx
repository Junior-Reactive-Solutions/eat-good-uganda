...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'b/:slug', element: <Lazy><BakeryPage /></Lazy> },
      { path: 'b/:slug/products/:productSlug', element: <Lazy><ProductPage /></Lazy> },
      { path: 'b/:slug/checkout', element: <Lazy><CheckoutPage /></Lazy> },
      ...
      { path: 'contact', element: <Lazy><ContactPage /></Lazy> },
      {
        ...
        children: [
          { index: true, element: <Lazy><AccountPage /></Lazy> },
